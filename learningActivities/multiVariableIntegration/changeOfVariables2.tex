...
The mass element is $dM = \delta(\rho)\,dV = \answer{k\rho \cdot \rho^2\sin(\phi)}\,d\rho\,d\phi\,d\theta = k\rho^3\sin\phi\,d\rho\,d\phi\,d\theta$.

This makes the integral for total mass:

$$M = \int_{\answer{0}}^{\answer{2\pi}}\int_{\answer{0}}^{\answer{\pi}}\int_{\answer{0}}^{\answer{R}} \answer{k\rho^3\sin(\phi)}\,d\rho\,d\phi\,d\theta$$

\textbf{Inner integral (in $\rho$):}
$$\int_0^R k\rho^3\sin(\phi)\,d\rho = \sin(\phi)\left[\answer{\frac{k\rho^4}{4}}\right]_0^R = \answer{\sin(\phi)kR^4/4}$$
