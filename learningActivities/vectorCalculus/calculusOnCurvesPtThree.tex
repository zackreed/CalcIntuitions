...
After exploring, verify your understanding (Select All that Apply):
\begin{selectAll}
...
\begin{problem}
Let's solidify understanding with a comprehensive example. Consider $\vec{r}(t) = \langle t, t^3/3, \sqrt{2}t^2/2 \rangle$ from $t=0$ to $t=1$.
