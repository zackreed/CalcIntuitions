...
\begin{feedback}
 Remember that looking into the $x-z$ plane means that the $y-$axis is pointed out of the screen at you. Similarly the $y-z$ plane has the $x-$axis pointed out of the screen, and the $x-y$ plane has the $z-$axis pointed out of the screen.
\end{feedback}
...
\begin{problem}
    ...
    \begin{itemize}
        ...
        \item $\vec{s}(2) = [\sin(4), e^2, \sqrt{2}] \approx [\answer[tolerance=.01]{-0.757}, \answer[tolerance=.01]{7.389}, \answer[tolerance=.01]{1.414}]$
    \end{itemize}
    ...
    \begin{enumerate}
        ...
        The $x$-component is: $r_2 s_3 - r_3 s_2 \approx \answer[tolerance=0.5]{-16.5}$
        
        The $y$-component is: $r_3 s_1 - r_1 s_3 \approx \answer[tolerance=0.5]{-8.4}$
        
        The $z$-component is: $r_1 s_2 - r_2 s_1 \approx \answer[tolerance=0.5]{32.6}$

        
        \item The cross product $\vec{r}(2)\times \vec{s}(2)$ produces a vector that is perpendicular to both $\vec{r}(2)$ and $\vec{s}(2)$. Which diagram correctly shows the cross product vector? (note the orientation of $x$, $y$, and $z$)
        \begin{multipleChoice}
            \choice{
