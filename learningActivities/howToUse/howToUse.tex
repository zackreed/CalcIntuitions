...
\begin{center}
  \includegraphics[width=.75\textwidth]{progress_bar.png}
\end{center}
...
\begin{center}
  \includegraphics[width=.75\textwidth]{update.png}
\end{center}
If you click the ``update'' button, a dialog will appear:
\begin{center}
  \includegraphics[width=.75\textwidth]{updateDialog.png}
\end{center}
