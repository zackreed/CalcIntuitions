    ...
    \begin{enumerate}
        ...
        \begin{multipleChoice}
            ...
            \choice[correct]{
                \begin{tikzpicture}[scale=0.75, thick, >=stealth]
                    \draw[->] (0,0) -- (1,6) node[midway,left] {$\vec{v}$};
                    \draw[->] (1,6) -- (-4,8) node[midway,above right] {$\vec{u}$};
                    \draw[->,thick,blue] (0,0) -- (-4,8) node[midway,below right] {$\vec{v}-\vec{u}$};
                    \draw[gray,dashed] (-5,0) -- (2,0);
                    \draw[gray,dashed] (0,-1) -- (0,10);
                \end{tikzpicture}
            }
        \end{multipleChoice}
    \end{enumerate}
...
\begin{problem}
    ...
    \begin{multipleChoice}
        ...
        \choice{They will move directly upwards.}
        \choice[correct]{They will move to the right and upwards.}
