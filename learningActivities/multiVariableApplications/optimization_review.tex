...
Even though the derivative is zero at $x=0$, if you move forward in $x$, the function \wordChoice{\choice{decreases}\choice[correct]{increases}}; and if you move backward in $x$, the function \wordChoice{\choice[correct]{decreases}\choice{increases}}. So there \wordChoice{\choice[correct]{is no}\choice{is a}} max or min at this critical point!
\end{problem}
