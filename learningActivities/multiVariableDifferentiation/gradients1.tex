...
Before practicing building more tangent planes, watch the following animation to gain a visual intuition of what tangent plan approximations look like at different points on a surface, and how we build them from partial derivatives.
