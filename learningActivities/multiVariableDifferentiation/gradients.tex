...
where $dy$ is a tiny ``differential'' (meaning linear) change in the output of the function and $dx$ is a tiny ``differential'' change in the input. In this context, ``differential'' is a special keyword for linear, but linear only in a tiny window around the point $(a,f(a))$.
