...
The decimals are based on the accuracy within MATLAB, so if you're using a calculator or another system, the errors might be off.

Remember the basic model. 

Be sure to reference the animation.
\end{feedback}
