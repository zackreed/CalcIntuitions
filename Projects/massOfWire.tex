...
\begin{example}
\textbf{Refining the Approximation Using Smaller Scales}
...
The small bit of mass are the differential bits whose ``total sum" is really the limit of the finit sums.
