...
First, the following video introduces the main contextual goal: modeling data with polynomials.
...
Now watch a video exploring the idea of generating and then minimizing data.
...
Now we can start using gradient descent to find minimum values and learn a model to fit our data. First check out the following video:
